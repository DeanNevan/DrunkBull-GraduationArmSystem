...
from DepthRestorationWorker import DepthRestorationWorker
...
class DepthRestoration:
    def __init__(self) -> None:
        ...
        parser.add_argument('--val_data_type', type=str,
                            default='real', help='type of val dataset (real/sim)')
        ...
        self.worker = DepthRestorationWorker(args, net, device_list, model_path)

    def work(self, color_np, sim_depth_np):
        return self.worker.work(color_np, sim_depth_np)
